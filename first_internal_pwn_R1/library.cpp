...
void cheat::modWalkSpeed(uintptr_t localPlayerPtr1, float speed_modifier) {
...
void cheat::increaseJumpSpeed(uintptr_t localPlayerPtr1, float speed_modifier) {
...
void cheat::increaseJumpHoldTime(uintptr_t localPlayerPtr1, float hold_modifier) {
		...
		*jhtPtr = (float)0.200000003 + hold_modifier;
}
