...
namespace cheat {
    ...
    void modWalkSpeed(uintptr_t localPlayerPtr1, float speed_modifier);
    void increaseJumpSpeed(uintptr_t localPlayerPtr1, float speed_modifier);
    void increaseJumpHoldTime(uintptr_t localPlayerPtr1, float hold_modifier);
